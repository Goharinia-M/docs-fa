...
- عدم مقداردهی پراپ با تایپ `boolean` مقدار `true` را خواهد داشت. می‌توان این تنظیمات را با مقداردهی `default` تغییر داد. برای مثال: `default: undefined` تا رفتاری مانند تایپ‌های non-Boolean داشته باشد.
